...
CHIME_IN = CONSTANT.chime_in
CHIME_IN_DESC = CONSTANT.chime_in_desc
...
EXECUTE_SCRIPT_DESC = CONSTANT.execute_script_desc
READ_REFERENCE = CONSTANT.read_reference
READ_REFERENCE_DESC = CONSTANT.read_reference_desc
